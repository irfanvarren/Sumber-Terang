...
import com.irfanvarren.myapplication.PaymentFragment;
 ...
 * Use the {@link SellCheckoutFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SellCheckoutFragment extends Fragment implements PurchaseItemListAdapter.CartItemListener, AddCartItemDialogFragment.OnFinishListener  {
     ...
     * @return A new instance of fragment SellCheckoutFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static SellCheckoutFragment newInstance(String param1, String param2) {
        SellCheckoutFragment fragment = new SellCheckoutFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_sell_checkout, container, false);
        ...
        checkoutBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                PaymentFragment sellFragment = new PaymentFragment();
                ...
                ft.replace(R.id.fragment_container_view, sellFragment);
    ...
    public void onFinish(Integer position, Product product, Integer qty, Double price) {
        ...
        Log.d("ITEM_POSISION",String.valueOf(position));
